...
namespace KeyboardClassLibrary
{
    public partial class Keyboardcontrol : UserControl
    {
        ...
        public BoW KeyboardType
        {
            ...
            set
            {
                ...
                {
                    //pictureBoxKeyboard.Image = KeyboardClassLibrary.Properties.Resources.tecladovirtual;
                ...
                {
                    pictureBoxKeyboard.Image = KeyboardClassLibrary.Properties.Resources.TecladoNovo;
                }
                else   //   kids keyboard
                {
        ...
        private void pictureBoxKeyboard_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else if (pvtKeyboardType == BoW.Numeric) pvtKeyboardKeyPressed = HandleNumericMouseClick(xpos, ypos);
        ...
        private string HandleNumericMouseClick(Single x, Single y)
        {
            string Keypressed = null;
            ...
            if (y < 73)
            {
                if (x >= 30 && x < 253) Keypressed = "1";
                else if (x >= 253 && x < 403) Keypressed = "2";
                else if (x >= 405 && x < 630) Keypressed = "3";
                else if (x >= 790 && x < 989) Keypressed = "{BACKSPACE}";
            }
            else if (y >= 73 && y < 141)
            {

                if (x >= 30 && x < 253) Keypressed = "4";
                else if (x >= 255 && x < 410) Keypressed = "5";
                else if (x >= 405 && x < 630) Keypressed = "6";
                else if (x >= 790 && x < 989) Keypressed = "{ENTER}";
            }
            else if (y >= 141 && y < 209)
            {
                if (x >= 30 && x < 253) Keypressed = "7";
                else if (x >= 255 && x < 403) Keypressed = "8";
                else if (x >= 405 && x < 630) Keypressed = "9";
                else if (x >= 790 && x < 989) Keypressed = "{ENTER}";
            }
            else if (y >= 209 && y < 277)
            {
                if (x >= 30 && x < 440) Keypressed = "0";
                else if (x >= 445 && x < 665) Keypressed = ".";
            }
            if (capslockindicator && x < 491) return "+" + Keypressed;
            else return Keypressed;
        }
    ...
    public enum BoW { Standard, Alphabetical, Kids, Numeric };
}
