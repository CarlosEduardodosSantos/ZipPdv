...
using Zip.Pdv.Properties;
using KRBTabControlTest.Win32;

namespace Zip.Pdv.Component.CustomTab
{
    ...
    public class KRBTabControl : TabControl
    {
        ...
        [Browsable(true)]
        private TabAlignments Alignments
        {
        ...
        [Browsable(true)]
        private UpDown32Style UpDownStyle
        {
            ...
            if (!DesignMode)
            {
                ...
                if (drgevent.KeyState == 1 && over != null)
                {
                    ...
                    if (overringTabIndex != draggingTabIndex)
                    {
                        ...
                        if (_upArrow == null)
                            _upArrow = new ArrowWindow(Resources.UpArrow1, 0.5);

                        if (_downArrow == null)
                            _downArrow = new ArrowWindow(Resources.UpArrow1, 0.5);
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                else
                {
                    if (this.TabCount >= 1)
                    {
                        ...
                        bool flag = closingTabPage.IsClosable && !closingTabPage.IsEdition ? closingTabPage.Enabled : false;

                        if (_imgCloseRectangle.Contains(e.Location) && flag)
                        {
                            _tabCloseBtn = TabCloseImage.Normal;
