...
{
    public class ProdutoOpcaoRepository : RepositoryBase, IProdutoOpcaoRepository
    {
        ...
        public IEnumerable<ProdutoOpcaoTipo> GetByprodutoId(int produtoId)
        {
            var sql = new StringBuilder();
            ...
            sql.AppendLine("Where ProdutosOpcaoTipoRelacao.ProdutoId = @produtoId");
            ...
            using (var conn = Connection)
            {
                ...
                conn.Query<ProdutoOpcaoTipo, ProdutoOpcao, ProdutoOpcaoTipo>(sql.ToString(),
                    (pot, po) =>
                    {
                        ...
                        return shop;
                    }, new { produtoId }, splitOn: "ProdutosOpcaoTipoId, ProdutosOpcaoId").AsQueryable();
        ...
        public IEnumerable<ProdutoOpcaoTipo> ObterTipoAll()
        {
            using (var conn = Connection)
            {
                ...
                conn.Query<ProdutoOpcaoTipo, ProdutoOpcao, ProdutoOpcaoTipo>(sqlTp1.ToString(),
                    ...
                    }, splitOn: "ProdutosOpcaoTipoId, ProdutosOpcaoId").AsQueryable();
